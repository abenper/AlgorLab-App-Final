...
public class AlumnosPanel extends JPanel {
    ...
    public AlumnosPanel(menu.Frame marco) {
        this.marco = marco;
        initComponents();
        setSize(850, 461);
    ...
    private void activarBotones() {
        if (btnLock.isSelected()) {
            ...
            apr.btnConfirmar.setEnabled(true);
            apr.btnBorrar.setEnabled(true);
        } else {
            btnLock.setIcon(iconLock);
            btnInsert.setEnabled(false);
            btnUpdate.setEnabled(false);
            btnDelete.setEnabled(false);
            apr.btnConfirmar.setEnabled(false);
            apr.btnBorrar.setEnabled(false);
        }
    }

    public void showTable() {
        tablaResult.setVisible(true);
        tablaResult.setModel(ba.slqUsuario());
    ...
    private void addForm() {
        marco.add(apr, BorderLayout.EAST);
    ...
    private void initComponents() {
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(46, 364, 43, -1));
        ...
        jLabel3.setText("Controles de operación");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(588, 364, 228, -1));
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        apr.labelOperacion.setForeground(Color.green);
        apr.labelOperacion.setText("INSERTAR");
        apr.textFecha.setEnabled(false);
    }//GEN-LAST:event_btnInsertActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        apr.labelOperacion.setForeground(Color.red);
        apr.labelOperacion.setText("Borrar");
        apr.textFecha.setEnabled(true);
    }//GEN-LAST:event_btnDeleteActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        apr.labelOperacion.setForeground(Color.blue);
        apr.labelOperacion.setText("Actualizar");
        apr.textFecha.setEnabled(true);
    ...
    DbAlumno ba = new DbAlumno();
    AlumnosPanelResultados apr = new AlumnosPanelResultados(this);
    menu.Frame marco;
